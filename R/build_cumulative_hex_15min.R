...
cat(';
        ...
        legend.onAdd = function() {
            ...
            div.innerHTML += "<div style=\\"font-size:10px;color:#666;margin-top:12px;padding-top:8px;border-top:1px solid #e5e7eb;line-height:1.4;\\">Occurrences = Nombre de fois qu'une panne a été détectée dans cet hexagone lors des lectures aux 15 minutes</div>";
            return div;
        };
        legend.addTo(map);
